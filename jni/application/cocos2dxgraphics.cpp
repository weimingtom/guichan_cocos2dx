...
namespace gcn
{
    ...
    COCOS2DXGraphics::COCOS2DXGraphics()
    {
        mAlpha = false;
    }

    void COCOS2DXGraphics::_beginDraw()
    {
        Rectangle area;
        area.x = 0;
        area.y = 0;
    ...
    void COCOS2DXGraphics::_endDraw()
    {
        popClipArea();
    }

    void COCOS2DXGraphics::setTarget(SDLMOD_Surface* target)
    {
        mTarget = target;
    }

    bool COCOS2DXGraphics::pushClipArea(Rectangle area)
    {
        SDLMOD_Rect rect;
    ...
    void COCOS2DXGraphics::popClipArea()
    {
...
#ifdef _DEBUG
		//fprintf(stderr, 
		//	"[COCOS2DXGraphics::popClipArea]rect={x=%d, y=%d, w=%d, h=%d}\n", 
		//	rect.x, rect.y, rect.w, rect.h);
#endif
    }

    SDLMOD_Surface* COCOS2DXGraphics::getTarget() const
    {
        return mTarget;
    }
    ...
    void COCOS2DXGraphics::fillRectangle(const Rectangle& rectangle)
    {
        if (mClipStack.empty())
        {
            throw GCN_EXCEPTION("Clip stack is empty, perhaps you called a draw funtion outside of _beginDraw() and _endDraw()?");
    ...
    void COCOS2DXGraphics::drawPoint(int x, int y)
    {
        if (mClipStack.empty())
        {
            throw GCN_EXCEPTION("Clip stack is empty, perhaps you called a draw funtion outside of _beginDraw() and _endDraw()?");
    ...
    void COCOS2DXGraphics::drawHLine(int x1, int y, int x2)
    {
        if (mClipStack.empty())
        {
            throw GCN_EXCEPTION("Clip stack is empty, perhaps you called a draw funtion outside of _beginDraw() and _endDraw()?");
    ...
    void COCOS2DXGraphics::drawVLine(int x, int y1, int y2)
    {
        if (mClipStack.empty())
        {
            throw GCN_EXCEPTION("Clip stack is empty, perhaps you called a draw funtion outside of _beginDraw() and _endDraw()?");
    ...
    void COCOS2DXGraphics::drawLine(int x1, int y1, int x2, int y2)
    {
        if (mClipStack.empty())
        {
            throw GCN_EXCEPTION("Clip stack is empty, perhaps you called a draw funtion outside of _beginDraw() and _endDraw()?");
    ...
    void COCOS2DXGraphics::setColor(const Color& color)
    {
        mColor = color;
    ...
    const Color& COCOS2DXGraphics::getColor() const
    {
        return mColor;
    }

    void COCOS2DXGraphics::drawSDLSurface(SDLMOD_Surface* surface,
                                     SDLMOD_Rect source,
